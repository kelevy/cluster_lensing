...
save_loc_results = '/Volumes/Extreme_SSD/cluster_lensing/results/foreground_bias_unlensed'
...
fig.savefig(save_loc_results+'/foreground_bias.eps', dpi = 200., bbox_inches = 'tight', pad_inches = 0.1)
