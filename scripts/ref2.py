...
save_loc_results = '/data/gpfs/projects/punim1922/cluster_lensing/results/ref2'
...
for j, offset in enumerate(offsets): 
    ...
    for i in range(nber_runs):
        ...
        # computing tSZ stack
        stack_tsz, _ = lensing_estimator.get_tsz(maps[i*nber_clus:i*nber_clus+nber_clus], 
                                                 map_params, 
                                                 weights_gradient, 
                                                 cutout_size_am = cutout_size_am)
