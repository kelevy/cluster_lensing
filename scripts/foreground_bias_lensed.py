...
save_loc_results = '/Volumes/Extreme_SSD/cluster_lensing/results/foreground_bias_lensed'
...
for i in tqdm(range(nber_runs)):    
    ...
    for  j in range(len(maps)):
        if j == 0:
            stack_aligned, cutouts_aligned, weights_gradient, angle_arr = lensing_estimator.get_aligned_stack(maps[j][i*nber_clus:i*nber_clus+nber_clus], 
                                                                                                   map_params, 
                                                                                                   l = l, cl = cl, 
                                                                                                   cl_noise = cl_noise, 
...
L_arr_sorted = [L_arr_sorted[0][s:e], L_arr_sorted[1][s:e], L_arr_sorted[2][s:e], 
                ...
                L_arr_sorted[6][s:e], L_arr_sorted[7][s:e]]
L_ip_arr_sorted = [L_ip_arr_sorted[0][s:e], L_ip_arr_sorted[1][s:e], L_ip_arr_sorted[2][s:e],            
                   ...
                   L_ip_arr_sorted[6][s:e], L_ip_arr_sorted[7][s:e]]
...
titles = ['Baseline', '+ kSZ', '+ tSZ', '+ tSZ Corrected', '+ tSZ Corrected (fit)', 
          r'+ kSZ $&$ tSZ', r'+ kSZ $&$ tSZ Corrected', r'+ kSZ $&$ tSZ Corrected (fit)']
...
mass_arr = [median_mass_arr_sorted[0][s:e], median_mass_arr_sorted[1][s:e], median_mass_arr_sorted[3][s:e], median_mass_arr_sorted[5][s:e]]
