...
def power_spectra_dic(map_dic = None, map_params = None, components = 'all', experiment = None):
    ...
    if map_dic is None:
        ...
        l = np.arange(10001)
        nl_dic = mockobs.noise_power_spectra_dic(experiment, l, deconvolve = True, use_cross_power = True)
        ...
        for cntr1, freq1 in enumerate( freqarr ):
            for cntr2, freq2 in enumerate( freqarr ):
                ...
                l, cl = utils.power_spectra(mapparams, map1, map2 = None, binsize = None)
...
def ilc_map(map_dic, opbeam, map_params, experiment, components = 'all', cov_from_sims = True):
    ...
    for currW in weights_arr:
        ...
        currW_2D = utils.convert_to_2d(grid, l, currW)
    ...
    for currB in bl_rebeam_arr:
        ...
        currB_2D = utils.convert_to_2d(grid, l, currB)
