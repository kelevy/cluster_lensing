...
save_loc_results = '/data/gpfs/projects/punim1922/cluster_lensing/results/pipeline_validation/'
...
if not os.path.exists(save_loc_results+'stacked_dipoles_cutoutsize'+str(cutout_size_am)+'arcmin_'+str(M_input_arr[-1]*1e-14)+'1e14M_sun_'+str(beam_fwhm)+'arcmin_'+str(noiseval_white)+'uKarcmin_'+str(nber_clus)+'sims.npy'):
    stacks_dipole_all = []
    ...
    stacks_dipole_all = np.load(save_loc_results+'stacked_dipoles_cutoutsize'+str(cutout_size_am)+'arcmin_'+str(M_input_arr[-1]*1e-14)+'1e14M_sun_'+str(beam_fwhm)+'arcmin_'+str(noiseval_white)+'uKarcmin_'+str(nber_clus)+'sims.npy')
    covariance_matrices_all = np.load(save_loc_results+'covariance_matrices_cutoutsize'+str(cutout_size_am)+'arcmin_'+str(M_input_arr[-1]*1e-14)+'1e14M_sun_'+str(beam_fwhm)+'arcmin_'+str(noiseval_white)+'uKarcmin_'+str(nber_clus)+'sims.npy')
...
plt.show()
fig.savefig(save_loc_results+'likelihoods_check.pdf', dpi = 200., bbox_inches = 'tight', pad_inches = 0.1)    
