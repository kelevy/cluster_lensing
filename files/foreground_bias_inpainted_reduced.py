...
save_loc_results = '/Volumes/Extreme_SSD/cluster_lensing/results/foreground_bias_inpainted_reduced'
...
stack_bg = np.load('/Volumes/Extreme_SSD/cluster_lensing/results/foreground_bias_inpainted/background_stack_cutoutsize6arcmin_1.0arcmin_2.0uKarcmin_50000sims.npy') 
...
maps = [mockobs_lensed_tSZ, mockobs_lensed_kSZ_tSZ]  
...
dipole_checks = [stacks_dipole[0], stacks_dipole[1]]
...
titles = ['tSZ corrected', '+ kSZ & tSZ Corrected']
...
nber_runs = 10
s,e = 3,13
L_arr_sorted = [L_arr_sorted[0][s:e], L_arr_sorted[1][s:e]]
L_ip_arr_sorted = [L_ip_arr_sorted[0][s:e], L_ip_arr_sorted[1][s:e]]
...
titles = ['+ tSZ Corrected', r'+ kSZ $&$ tSZ Corrected']
...
xvals = [0.02, 0.02]
yvals = [0.40, 0.60]
titles_arr = ['+ tSZ corrected', r'+ kSZ $&$ tSZ corrected']
ax.set_ylim(0.,1)
markers = ['o', '^']
